...
<html lang="en">
    ...
    <div class="container" style="margin: 3% auto;">
        <div class="row">
            <div class="card">
                <div class="card-header">Check Your Flight Status</div>

                <div class="card-body">
                    <form action="${pageContext.request.contextPath}/flight-status" method="post" >
        ...
        <script>
            function displayStatus() {
                document.getElementById("myFlightCurrentStatus").style.display = "block";
            }
        </script>
    </body>
</html>